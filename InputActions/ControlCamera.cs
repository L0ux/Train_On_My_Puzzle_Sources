...
public class @ControlCamera : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""99fbc3b6-0c99-4270-b136-bae78a8318d5"",
        ...
        {
            ""name"": ""Menu"",
            ""id"": ""2f8f0789-cfdb-41f9-ad24-a38e03487740"",
            ""actions"": [
                {
                    ""name"": ""Pause"",
                    ""type"": ""Button"",
                    ""id"": ""4a228fec-28c4-451c-808d-1be8e29fd1b4"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""8537d39b-11cf-4062-98c2-259336ffc193"",
    ...
    {
        private @ControlCamera m_Wrapper;
        public MenuActions(@ControlCamera wrapper) { m_Wrapper = wrapper; }
